...
type HardWare struct {
	...
	CreateTime     *time.Time `gorm:"column:create_time;type:date" json:"createTime"`
	UpdateTime     *time.Time `gorm:"column:create_time;type:int;type:unsigned;autoCreateTime" json:"updateTime"`
	MonitorStatus  *int32     `gorm:"column:monitor_status;type:int" json:"monitorStatus"`
	Location       *string    `gorm:"column:location;type:varchar(12)" json:"location"`
